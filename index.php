...
<div class="contenedor">
    ...
    <?php } else { 
            echo "<h3 style='text-align: center;    '>Selecciona un Proyecto a la izquierda</h3>";
        }  ?>
            ...
            <ul>
                <?php 
                    ...
                    if($tareas->num_rows > 0){
                        ...
                        echo "<p class='lista-vacia'>No existen tareas en este proyecto</p>";
                    }
                ?>
            </ul>
        </div>
